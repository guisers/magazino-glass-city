<div class="single-meta">
	<div><?php echo get_avatar( get_the_author_meta('email') , 90 ); ?></div>
...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-pad'); ?>>
	...
	<div class="content-author-bio">
		<div class="author-bio-img"><?php echo get_avatar( get_the_author_meta('email') , 90 ); ?></div>
		<div class="author-bio-info">
			<h3><?php echo get_the_author(); ?></h3>
			<?php echo get_the_author_meta('description'); ?>
		</div>
	</div>--><!-- .content-author-bio -->
